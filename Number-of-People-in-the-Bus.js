...
// Even though it is the last bus stop, the bus might not be empty and some people might still be inside the bus, they are probably 
// sleeping there :D
...
function numPeopleOnTheBus(busStops){
    let totalPeople = 0
